...
export const proposals: Proposal[] = [
  ...
  },
  {
    ...
    impact: "높음",
    summary:
      "커튼/블라인드는 이사·리모델링·계절 교체 주기로 재구매가 발생하는 상품입니다. 지금 customers 테이블에 모든 과거 고객 정보가 쌓여 있지만, 이 데이터를 다시 마케팅에 쓰는 기능이 전혀 없습니다. 시공 완료 후 그대로 방치되는 구조입니다.",
    benefits: [
    ...
    howItWorks:
      "고객의 completedAt(시공 완료일) 기준으로 일정 기간(예: 11개월, 다음 계절 시작 전)이 지나면 관리자 대시보드에 '리마케팅 대상' 목록으로 자동 표시합니다. 소개로 들어온 신규 고객은 문의 등록 시 '소개자' 필드를 남겨, 소개해준 고객에게 감사 인사·소개 혜택을 챙길 수 있게 합니다.",
    steps: [
      "customers 또는 inquiries에 '소개자(referrer_customer_id)' 필드 추가 — 신규 문의 등록 시 선택 입력",
      "완료일 기준 N개월 경과 고객을 자동으로 뽑아주는 '리마케팅 대상' 목록 화면 추가",
      "관리자가 목록에서 바로 전화/문자 보내기(이미 있는 QuickActions 컴포넌트 재사용 가능)",
      "소개 건수가 많은 고객을 상단에 보여줘 우수 소개자 관리(감사 선물 등) 가능하게 함",
    ],
    caveats: [
      "문자 대량 발송까지 자동화하려면 SMS API 연동이 필요 — 지금은 '대상자 목록 보여주기'까지만 자동화하고, 실제 연락은 수동으로 진행하는 것이 현실적",
    ],
  },
  {
